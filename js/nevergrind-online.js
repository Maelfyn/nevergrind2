(function($,Math,document,location,TweenMax,TimelineMax,Power0,Power1,Power2,Power3,Power4,Back,Elastic,Bounce,SteppedEase,Circ,Expo,Sine,setTimeout,setInterval,undefined){// stuff that must exist before everything
var init = {
...
init.isMobile = init.checkMobile();var create = {
	selected: 0,
	base: {
		str: 0,
		sta: 0,
...
location.search === '?create' && g.goCreateCharacter();// env.js
